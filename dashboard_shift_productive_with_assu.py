...
def load_data():
    ...
    with st.spinner('Loading data from Hugging Face...'):
        try:
            # Use DuckDB to read parquet directly from URL
            ...
            st.info("Please ensure the Hugging Face dataset URL is correct and publicly accessible.")
            raise
...
def show_dashboard_page():
    ...
    try:
        ...
        st.info("Please check if the Hugging Face dataset is accessible.")
